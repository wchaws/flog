...
func WAFALB(t time.Time) string {
	//no++
	return fmt.Sprintf(
		WAFALBLog,
		t.UnixMilli(),
...
func WAFSQLIngestion(t time.Time) string {
	//no++
	return fmt.Sprintf(
